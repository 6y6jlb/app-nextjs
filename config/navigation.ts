...
export const LINKS: ILinks = {
    ...
    [LINK_TYPE_ENUM.SNEAKY]: [
        { path: 'weather', title: 'naviagtiion.weather', type: PATH_TYPE_ENUM.ROUTE },
        { path: 'profile', title: 'naviagtiion.profile', type: PATH_TYPE_ENUM.ROUTE },
        { path: 'tasks', title: 'naviagtiion.tasks', type: PATH_TYPE_ENUM.ROUTE },
    ]
}
